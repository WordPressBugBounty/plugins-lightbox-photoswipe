<table id="lbwps-tab-2" class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <label><?php $this->uiControlCheckbox('fix_scaled') ?>&nbsp;<?php echo __('Fix links to scaled or rotated images (e.g. "image.jpg" instead of "image-scaled.jpg" or "image-rotated.jpg")', 'lightbox-photoswipe'); ?></label><br>
